...
Image * img_ConvertGray(Image * origImg)
{
    int x, y;
    int j,i,soma;
    int pontos [3][3] = {{-1,-1,-1},{-1,8,-1},{-1,-1-1}};
    int pontos2 [3][3] = {{-1,-1,-1},{-1,8,-1},{-1,-1-1}};
    ...
    for (y = 0; y < imgGetHeight(origImg); y++)
    {
        for (x = 0; x < imgGetWidth(origImg); x++)
        {
            for (j=-1; j<=1; j++)
            {
                for (i=-1; i<=1; i++)
                {
                    soma += pontos[j+1][i+1]*imgGetPixelGreen(origImg, x+i, y+j);
                }
            }
    ...
    for (y = 0; y < imgGetHeight(origImg); y++)
    {
        for (x = 0; x < imgGetWidth(origImg); x++)
        {
            for (j=-1; j<=1; j++)
            {
                for (i=-1; i<=1; i++)
                {
                    soma += pontos2[j+1][i+1]*imgGetPixelGreen(origImg, x+i, y+j);
                }
            }
